...
if _platform == "win32" or _platform == "win64":
    ...
    HISTORY_UPDATEDATEinLOCAL_FILENAME = '/Users/oms1226/.sleepwatcher/%s.latest_updatetime.local' % TABLE_NAME
...
if __name__ == "__main__":
    ...
    while len(sys.argv) > 1:
        ...
        #python /Users/oms1226/_workspace/pyTest4Android/toolbox/py_batch/DBUpdateAndBackupAfterCheck.py --localhost=/Users/oms1226/Downloads/_wikibackup
            ...
            sys.argv.pop(1)
        elif len(sys.argv) > 1 and '--uploadOnly' in sys.argv[1]:
            synctype = SyncType.UPLOADONLY
            sys.argv.pop(1)
        elif len(sys.argv) > 1 and '--downloadOnly' in sys.argv[1]:
            synctype = SyncType.DOWNLOADONLY
            sys.argv.pop(1)
        else:
            sys.argv.pop(1)
